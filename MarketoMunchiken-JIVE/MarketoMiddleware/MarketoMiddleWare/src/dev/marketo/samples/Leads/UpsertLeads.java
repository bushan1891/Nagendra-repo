...
public class UpsertLeads {
	...
	public String lookupField ="email"; //defines the field to deduplicate off of
	public String action="createOrUpdate"; //createOnly, updateOnly, createOrUpdate, or createDuplicate
	...
	public static void createLead(String email){
		...
		lead1.add("firstName", "Testing Lead");
		...
		upsertLeads.leads = new JsonObject[]{lead1};// add out leads {lead1,lead2}
